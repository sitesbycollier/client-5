export const HeroVideo = () => {
  return (
    <div className="self-start bg-[position:0px_0px] caret-transparent col-end-2 col-start-1 row-end-5 row-start-1 h-[301px] justify-self-start ml-[calc(50%_-_490px)] min-h-[auto] min-w-[auto] pointer-events-auto relative no-underline w-[360px] mt-[19px] -mb-1.5 left-3">
      <div
      ...
      >
        <div className="bg-[position:0px_0px] caret-transparent h-full min-h-full min-w-full outline-[3px] relative no-underline w-full z-0 overflow-hidden font-helveticaneuew01_45ligh">
          ...
          <div className="items-center bg-black bg-[position:0px_0px] caret-transparent flex flex-col h-full justify-center outline-[3px] absolute no-underline w-full z-50 inset-0">
            <img
              src="https://c.animaapp.com/Md3O0W-i1zJ4gC0H8Hka0g/assets/image-1.png"
              className="aspect-[auto_360_/_301] bg-[position:0px_0px] caret-transparent blur-[14px] h-[301px] outline-[3px] absolute no-underline align-baseline w-[360px] z-0 inset-0"
            />
            <video
              preload="none"
              autoplay=""
              playsInline="true"
              src="https://video.wixstatic.com/video/360fdc_0cebac2e09db4549bd0d083ab8451cdb/720p/mp4/file.mp4"
              muted=""
          ...
          <div className="bg-[position:0px_0px] caret-transparent flex flex-col outline-[3px] absolute no-underline inset-0">
            ...
            <div className="bg-[position:0px_0px] caret-transparent flex flex-col min-h-[auto] min-w-[auto] outline-[3px] no-underline z-[60]">
              <div className="bg-[position:0px_0px] caret-transparent min-h-[auto] min-w-[auto] opacity-0 outline-[3px] relative no-underline px-[15px] top-0.5">
                <div className="bg-[position:0px_0px] caret-transparent h-1.5 outline-[3px] relative no-underline w-full">
                  <div className="bg-[position:0px_0px] caret-transparent h-1.5 outline-[3px] no-underline scale-y-[0.34]">
                    <div className="bg-white/30 bg-[position:0px_0px] caret-transparent h-1.5 outline-[3px] absolute no-underline w-full"></div>
                    <div className="bg-white/30 bg-[position:0px_0px] caret-transparent h-1.5 outline-[3px] absolute no-underline w-full"></div>
                    <div className="bg-white/50 bg-[position:0px_0px] caret-transparent h-1.5 outline-[3px] absolute no-underline"></div>
                    <div className="bg-white bg-[position:0px_0px] caret-transparent h-1.5 outline-[3px] absolute no-underline origin-[0px_0px] w-full"></div>
                  ...
                  <div className="bg-[position:0px_0px] caret-transparent outline-[3px] absolute no-underline top-[-3px] translate-x-[330px] z-[7] -left-1.5"></div>
                </div>
              </div>
              <div className="bg-[position:0px_0px] caret-transparent flex grow-[2] min-h-[auto] min-w-[auto] outline-[3px] relative no-underline w-full">
                <div className="items-center bg-[position:0px_0px] caret-transparent flex basis-[0%] grow h-[42px] max-w-full min-h-[auto] min-w-[auto] opacity-0 outline-[3px] relative no-underline w-full">
                    ...
                    <div className="items-center bg-[position:0px_0px] caret-transparent flex justify-start outline-[3px] relative no-underline">
                      ...
                      >
                        <div className="bg-[position:0px_0px] caret-transparent hidden outline-[3px] no-underline">
                          <img
                            src="https://c.animaapp.com/Md3O0W-i1zJ4gC0H8Hka0g/assets/icon-2.svg"
                            alt="Icon"
                            className="caret-transparent outline-[3px] no-underline align-baseline w-full"
                          />
                          <img
                            src="https://c.animaapp.com/Md3O0W-i1zJ4gC0H8Hka0g/assets/icon-3.svg"
                            alt="Icon"
                        ...
                        <div className="bg-[position:0px_0px] caret-transparent min-h-[auto] min-w-[auto] outline-[3px] no-underline">
                          <img
                            src="https://c.animaapp.com/Md3O0W-i1zJ4gC0H8Hka0g/assets/icon-4.svg"
                            alt="Icon"
                            className="caret-transparent outline-[3px] no-underline align-baseline w-full"
                          />
                          <img
                            src="https://c.animaapp.com/Md3O0W-i1zJ4gC0H8Hka0g/assets/icon-5.svg"
                            alt="Icon"
                            className="caret-transparent hidden outline-[3px] no-underline align-baseline w-full"
                          />
                        </div>
                  ...
                  <div className="bg-[position:0px_0px] caret-transparent min-h-[auto] min-w-[auto] outline-[3px] no-underline mr-[13px]">
                    <div className="items-center bg-[position:0px_0px] caret-transparent flex justify-start outline-[3px] relative no-underline">
                      ...
                      >
                        <div className="bg-[position:0px_0px] caret-transparent min-h-[auto] min-w-[auto] outline-[3px] no-underline">
                          <img
                            src="https://c.animaapp.com/Md3O0W-i1zJ4gC0H8Hka0g/assets/icon-6.svg"
                            alt="Icon"
                            className="caret-transparent outline-[3px] no-underline align-baseline w-full"
                          />
                          <img
                            src="https://c.animaapp.com/Md3O0W-i1zJ4gC0H8Hka0g/assets/icon-7.svg"
                            alt="Icon"
                            className="caret-transparent hidden outline-[3px] no-underline align-baseline w-full"
                          />
                        </div>
                        <div className="bg-[position:0px_0px] caret-transparent hidden outline-[3px] no-underline">
                          <img
                            src="https://c.animaapp.com/Md3O0W-i1zJ4gC0H8Hka0g/assets/icon-8.svg"
                            alt="Icon"
                            className="caret-transparent outline-[3px] no-underline align-baseline w-full"
                          />
                          <img
                            src="https://c.animaapp.com/Md3O0W-i1zJ4gC0H8Hka0g/assets/icon-9.svg"
                            alt="Icon"
                            className="caret-transparent hidden outline-[3px] no-underline align-baseline w-full"
                          />
                        </div>
                        <div className="bg-[position:0px_0px] caret-transparent hidden outline-[3px] no-underline">
                          <img
                            src="https://c.animaapp.com/Md3O0W-i1zJ4gC0H8Hka0g/assets/icon-10.svg"
                            alt="Icon"
                            className="caret-transparent outline-[3px] no-underline align-baseline w-full"
                          />
                          <img
                            src="https://c.animaapp.com/Md3O0W-i1zJ4gC0H8Hka0g/assets/icon-11.svg"
                            alt="Icon"
                            className="caret-transparent hidden outline-[3px] no-underline align-baseline w-full"
                          />
                        </div>
                  ...
                  <div className="bg-[position:0px_0px] caret-transparent hidden outline-[3px] no-underline mr-[18px]">
                    <div className="items-center bg-[position:0px_0px] caret-transparent text-white flex shrink-0 h-[25px] outline-[3px] no-underline">
                      <span className="bg-[position:0px_0px] caret-transparent block text-xs leading-3 outline-[3px] no-underline">
                        00:10
                      </span>
                      <span className="bg-[position:0px_0px] caret-transparent block text-xs leading-3 outline-[3px] no-underline ml-[5px] before:accent-auto before:caret-transparent before:text-white before:text-xs before:not-italic before:normal-nums before:font-normal before:tracking-[normal] before:leading-3 before:list-outside before:list-disc before:outline-[3px] before:pointer-events-auto before:text-start before:no-underline before:indent-[0px] before:normal-case before:visible before:mr-1 before:border-separate before:font-helveticaneuew01_45ligh">
                        00:10
                      </span>
                    </div>
                  </div>
                </div>
                <div className="items-center bg-[position:0px_0px] caret-transparent flex basis-[0%] grow h-[42px] justify-end max-w-full min-h-[auto] min-w-[auto] opacity-0 outline-[3px] relative no-underline w-full">
                  <div className="bg-[position:0px_0px] caret-transparent min-h-[auto] min-w-[auto] outline-[3px] no-underline mr-2">
                    <div className="items-center bg-[position:0px_0px] caret-transparent flex justify-center outline-[3px] relative no-underline">
                      ...
                      >
                        <div className="bg-[position:0px_0px] caret-transparent min-h-[auto] min-w-[auto] outline-[3px] no-underline">
                          <img
                            src="https://c.animaapp.com/Md3O0W-i1zJ4gC0H8Hka0g/assets/icon-12.svg"
                            alt="Icon"
                            className="caret-transparent outline-[3px] no-underline align-baseline w-full"
                          />
                          <img
                            src="https://c.animaapp.com/Md3O0W-i1zJ4gC0H8Hka0g/assets/icon-13.svg"
                            alt="Icon"
                            className="caret-transparent hidden outline-[3px] no-underline align-baseline w-full"
                          />
                        </div>
                        <div className="bg-[position:0px_0px] caret-transparent hidden outline-[3px] no-underline">
                          <img
                            src="https://c.animaapp.com/Md3O0W-i1zJ4gC0H8Hka0g/assets/icon-14.svg"
                            alt="Icon"
                            className="caret-transparent outline-[3px] no-underline align-baseline w-full"
                          />
                          <img
                            src="https://c.animaapp.com/Md3O0W-i1zJ4gC0H8Hka0g/assets/icon-15.svg"
                            alt="Icon"
                            className="caret-transparent hidden outline-[3px] no-underline align-baseline w-full"
                          />
                        </div>
                  ...
                  <div className="bg-[position:0px_0px] caret-transparent hidden outline-[3px] no-underline mr-2">
                    <div className="items-center bg-[position:0px_0px] caret-transparent flex justify-center outline-[3px] relative no-underline">
                      ...
                      >
                        <img
                          src="https://c.animaapp.com/Md3O0W-i1zJ4gC0H8Hka0g/assets/icon-16.svg"
                          alt="Icon"
                          className="caret-transparent outline-[3px] no-underline align-baseline w-full"
                        />
                        <img
                          src="https://c.animaapp.com/Md3O0W-i1zJ4gC0H8Hka0g/assets/icon-17.svg"
                          alt="Icon"
                          className="caret-transparent hidden outline-[3px] no-underline align-baseline w-full"
                        />
                      </button>
                  ...
                  <div className="bg-[position:0px_0px] caret-transparent min-h-[auto] min-w-[auto] outline-[3px] no-underline mr-[7px]">
                    <div className="items-center bg-[position:0px_0px] caret-transparent flex justify-center outline-[3px] relative no-underline">
                      ...
                      >
                        <img
                          src="https://c.animaapp.com/Md3O0W-i1zJ4gC0H8Hka0g/assets/icon-18.svg"
                          alt="Icon"
                          className="caret-transparent outline-[3px] no-underline align-baseline w-full"
                        />
                        <img
                          src="https://c.animaapp.com/Md3O0W-i1zJ4gC0H8Hka0g/assets/icon-19.svg"
                          alt="Icon"
                          className="caret-transparent hidden outline-[3px] no-underline align-baseline w-full"
                        />
                      </button>
