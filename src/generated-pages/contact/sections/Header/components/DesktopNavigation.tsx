          ...
          <li className="bg-[position:0px_0px] box-border caret-transparent inline-block h-8 relative no-underline text-nowrap w-[135px]">
            ...
            >
              <div className="bg-[position:0px_0px] caret-transparent no-underline text-nowrap pl-[15px]">
                <div className="bg-zinc-300 bg-[position:0px_0px] shadow-[rgba(0,0,0,0.6)_0px_1px_4px_0px] caret-transparent absolute no-underline text-nowrap overflow-hidden rounded-[10px] left-[15px] right-0 inset-y-0">
